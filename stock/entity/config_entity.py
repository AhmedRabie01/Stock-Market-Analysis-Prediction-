...
from stock.constant import training_pipeline
from stock.constant.training_pipeline import ARTIFACT_DIR,PIPELINE_NAME
...
class ModelTrainerConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.expected_rmse: float = training_pipeline.MODEL_TRAINER_RMSE
